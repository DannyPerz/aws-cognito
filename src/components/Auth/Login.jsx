    ...
    <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
      <AuthPanel>
        ...
        {step === LOGIN_STEPS.LOGIN && (
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); clearOauthError(); handleSignIn(AUTH_METHODS.EMAIL_OTP); }}>
            <AuthTextField
        ...
        {step === LOGIN_STEPS.LOGIN_PASSWORD && (
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); clearOauthError(); handleSignIn(AUTH_METHODS.PASSWORD); }}>
            <AuthTextField
              label={LOGIN_UI.emailLabel}
              type="email"
              value={email}
